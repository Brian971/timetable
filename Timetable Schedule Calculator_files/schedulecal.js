...
yearSchedule[2014] = {
    begin: {
        year: 2014,
        day: new Date(2014, 8, 1) //September 3
    },
    vacationWeeks: [
        {
            displayName: "Winter break", //displayed name in the table
            begin: new Date(2014, 11, 19), //begin date of the vacation
            end: new Date(2015, 0, 12), //end date of the vacation
            weeks: 3 //weeks "skipped" from the schedule. TODO: see if this can be calculated from begin - end
        }, 
        {
            displayName: "Spring break",
            begin: new Date(2015, 2, 13),
        ...
        },
		{
            ...
            begin: new Date(2014, 9, 24),
            end: new Date(2014, 9, 25),
            weeks: 0
        },
		{
            displayName: "Thanksgiving",
            begin: new Date(2014, 9, 13),
